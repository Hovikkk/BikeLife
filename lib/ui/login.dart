            ...
            Expanded(
              ...
              child: Center(
                child: Container(
                  ...
                  child: Image(image: AssetImage(AppImages.bikeLifeLogo), color: Colors.white,))
              ),
            ),
            Expanded(
              flex: 30,
                  ...
                  CupertinoButton(
                    ...
                    child: Container(
                      ...
                      child: Center(
                          child: Text(
                        'Մուտք',
                        style: TextStyle(color: Colors.white, fontSize: DynamicSize.size(screenWidth: width, size: 16)),
                      )),
                    ),
                    onPressed: () {},
                  ),
                  CupertinoButton(
                    padding: EdgeInsets.symmetric(vertical: DynamicSize.size(screenWidth: width, size: 10)),
                    child: Container(
                      width: width * 0.7,
                      height: DynamicSize.size(screenWidth: width, size: 45),
                      decoration: BoxDecoration(
          ...
          CupertinoButton(
            ...
            child: Row(
              ...
              children: [
                ...
                Text(
                  'Հետ',
                  style: TextStyle(color: Colors.white, fontSize: DynamicSize.size(screenWidth: width, size: 20)),
                )
              ],
            ),
          ),
