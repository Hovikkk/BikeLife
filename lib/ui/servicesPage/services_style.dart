...
final double servicesTextWidth = DynamicSize.size(screenWidth: width, size: 155);
final double driveCompetentlyTextWidth = DynamicSize.size(screenWidth: width, size: 205);
